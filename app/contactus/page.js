  ...
  return (
    <main className="mt-16">
      <div className="w-[80%] mx-auto ">
        ...
        <div className="flex justify-between gap-10 pb-16 pt-28 bgContactUs">
          <div className=" w-[60%] flex flex-col gap-10 ">
            ...
            <p className=" w-[65%] fontGivonic text-xl font-medium">
              Get A Free Sample Slide Within 24 Hrs and Witness the Subtle Art
              Of Presenting!
            </p>
          ...
          <form className="w-[40%] flex flex-col justify-start items-end gap-7">
            ...
            <div className="flex flex-col gap-8 w-full mt-4">
              <p className="fontGivonic text-xl font-medium capitalize">
                get An instant quote from our customer support or submit the
