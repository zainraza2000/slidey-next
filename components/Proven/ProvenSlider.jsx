      ...
      <div className=" slide px-8">
        <div className=" w-full flex gap-2 justify-between items-center">
          <div className=" flex flex-col justify-center 2xl:gap-7 xl:gap-4 md:gap-2">
            <p className="fontGivonic text-[#000000] 2xl:text-[40px] xl:text-[28px] md:text-2xl font-semibold md:leading-10">
              Real Startups,
              <br />
              Real Success!
            </p>
            <p className="fontGivonic text-[#4D4D4D] xl:text-xl md:text-base font-normal">
