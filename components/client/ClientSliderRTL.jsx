...
const ClientSiderRTL = () => {
  ...
  return (
    <Slider {...settings}>
      <div className="slide">
        <Image src={image1} alt="logo" className=" mx-auto" />
      </div>
      <div className="slide">
        <Image src={image2} alt="logo" className=" mx-auto" />
      </div>
      <div className="slide">
        <Image src={image3} alt="logo" className=" mx-auto" />
      </div>
      <div className="slide">
        <Image src={image4} alt="logo" className=" mx-auto" />
      </div>
      <div className="slide">
        <Image src={image5} alt="logo" className=" mx-auto" />
      </div>
      <div className="slide">
        <Image src={image6} alt="logo" className=" mx-auto" />
      </div>
      <div className="slide">
        <Image src={image7} alt="logo" className=" mx-auto" />
      </div>
      <div className="slide">
        <Image src={image8} alt="logo" className=" mx-auto" />
      </div>
      <div className="slide">
        <Image src={image9} alt="logo" className=" mx-auto" />
      </div>
    </Slider>
  );
};
